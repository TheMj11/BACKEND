...
this._emptySession=k.from(d._createEmptySession(),void 0,void 0,void 0,void 0,this),this._currentSession=this._emptySession,this._runningAuthnPromise=null,this._restoreSessionPromise=null,
this._isRestoringSession=!1,this._listeners=[],this._globalSessionExpiring=!1,this._defaultAcrValues=r.getString("uu_app_oidc_requested_acr_values",!1),
this._defaultMaxAge=r.getNumber("uu_app_oidc_max_authentication_age",!1),this._defaultScopeMode=r.getString(C+this._serviceName+"_default_call_token_scope_mode")||"baseUri",
this._logger=c.get("uuapp.oidc.AuthenticationService"),this._redirectUri=v.toFullAppUrl(r.getString("uu_app_oidc_redirect_uri")||"/oidc/callback"),this._authnFlow=null,
...
this._sessionStateChangeNotifierInitialized=!1,this._sessionUntrusted=!1}getServiceName(){return this._serviceName}async getServiceUri(){return this._oauthClient||await this._loadOauthClientPromise,
...
this._isRestoringSession=!0,this._logger.debug(`Trying to restore session for ${this.getServiceName()}.`);let{acrValues:t,maxAge:i,callToken:n}=e||{}
;this._clientId=await w.getClientId(this._serviceName);let s,r,o=k.loadFromCache(this,this._clientId),a=this._loadAuthnConstraints();t||=a.acrValues||this._defaultAcrValues,
i||=a.maxAge||this._defaultMaxAge,o&&o.matches(t,i)?(this._logger.debug(`Session for ${this.getServiceName()} loaded from cache.`),s=this._authenticateBySession.bind(this),
...
!e.maxAge&&s.maxAge&&(e.maxAge=s.maxAge))
...
;return l=k.from(l,o.authenticationContext,o.globalSessionExpiresAt,o.globalSessionState,this),s={scope:o.scope,acrValues:o.acrValues,maxAge:o.maxAge},this._storeAuthnConstraints(s,l),
...
;r=k.from(r,n.authenticationContext,n.globalSessionExpiresAt,n.globalSessionState,this);let o={scope:n.scope,acrValues:n.acrValues,maxAge:n.maxAge};return this._storeAuthnConstraints(o,r),
...
;let r=await this._oauthClient.getSupportedAcrValues(),o=new d(this._serviceName,this._oauthClient,r,t,i,n);return o=k.from(o,null,null,null,null,this),o.getCallToken=async function(e=null,t={}){
...
e&&await this._authnFlow.isCheckSessionSupported()&&(this._sessionChecker=new S(this._authnFlow,e,this._clientId,(()=>this._currentSession.getState())),this._sessionChecker.onStateChange((()=>{
...
;n=k.from(n,i,e.globalSessionExpiresAt,e.globalSessionState,this),this._storeAuthnConstraints(t,n),this._currentSession=n,n&&(n._onCloseListener=this._onSessionClose.bind(this),
...
let k=Math.random().toString(32).substr(2),v=_.urlSafeEncode(JSON.stringify(this.createAuthState(y,m))),b=this._addUriParams(l,{max_age:p,login_hint:w,prompt:g,state:v,nonce:k,language:f
...
let l=h.getString(f+this._serviceName+"_logout_type")||S.type[this._serviceName],c=h.getNumber(f+this._serviceName+"_logout_popup_width")||S.popupWidth[this._serviceName]||m,u=h.getNumber(f+this._serviceName+"_logout_popup_height")||S.popupHeight[this._serviceName]||y,_="main"===l?o:"popup"===l?s:r
...
;const{BaseError:n,LruCache:s,Base64:r}=i(528),{AppClient:o,ApplicationError:a}=i(781),{InvalidCredentials:l,AuthenticationError:c}=i(57),{PerflogHandler:u,RemoteErrorHandler:h,RetryHandler:_,TransformParametersHandler:d}=i(781),{UriBuilder:p}=i(769),g=i(176),f=i(848),m=i(819),y=i(918),w=[u,h,_,d],S=[h,_,d],k={
maxAttempts:3,maxTimeInterval:3e4,baseTimeInterval:100,retryCondition:{httpMethods:["GET","POST"],httpStatusCodes:["5xx"]}
},v="client_id",b="application/x-www-form-urlencoded",C="application/json",A="scope",T="grant_type",x="token",I="token_type_hint",U="subject_token",P="subject_token_type",$="actor_token_type",R="refresh_token",E="urn:ietf:params:oauth:token-type:id_token",N="urn:ietf:params:oauth:token-type:access_token",O=`urn:ietf:params:oauth:token-type:${R}`,L="urn:ietf:params:oauth:grant-type:token-exchange",B="client_private_key",F="client_assertion",j="client_assertion_type",M="urn:ietf:params:oauth:client-assertion-type:jwt-bearer",z=/^[a-zA-Z0-9\-_]+\.[a-zA-Z0-9\-_]+\.[a-zA-Z0-9\-_]+$/,D=["none","low","medium","high","veryHigh"],V=["none","low","standard","high","veryHigh"]
...
"idToken"===t?o[$]=E:"accessToken"===t?o[$]=N:e.match(z)&&(o[$]=E),"idToken"===n?o[P]=E:"accessToken"===n?o[P]=N:i.match(z)&&(o[P]=E),o[A]=this._getOidcScope(r),await this._grantToken(o,s)}
...
_getTokenTypeHint(e,t=null){return t?"idToken"===t?E:"accessToken"===t?N:"refreshToken"===t?R:t:this._accessTokenPattern.test(e)?N:this._refreshTokenPattern.test(e)?O:z.test(e)?E:null}
...
;const{Config:n,Base64:s,BaseError:r,Digest:o,Json:a}=i(528),{UriBuilder:l}=i(769),{LoggerFactory:c}=i(50),u=i(57).AuthenticationService,h=i(57).Session,{Identity:_,ClientIdentity:d,ApplicationIdentity:p,UuAppKey:g}=i(57),{UntrustedCredentials:f}=i(57),m=i(716),y=i(986),w="uuidentity",S="uu_identity",k="name",v="acr",b="uuappkey",C="appkey",A="uuidentity_type",T="identity_type",x="uuidentity_account_type",I="urn:uuoidcclient:",U="standard"
;e.exports=class extends h{constructor(e,t,i,s=null,r=null,o=null){let a=null,l=null,u=null,h=null,f=null,m=null,y=null,P=null,$=s,R=`uu_app_oidc_providers_${e}_`;if($){a=$.jti,l=$.auth_id||$.sid
;let e=$.auth_time||$.iat;e&&(u=new Date(1e3*e));let t,s=$[v]
...
;let r=n.getString(`${R}uu_identity_claim`);if(t=r?$[r]:$[w]||$[S],t){let e=$.loa,i=$[v],n=$[b]||$[C];n&&(n=g.parse(n));let s=$[k];"0-0"===t&&(h=0);let r=$[A]||$[T],o=$[x]||U;f=new _(t,{name:s,
levelOfAssurance:e,type:r,authenticationLevelOfAssurance:i,uuAppKey:n,accountType:o}),f.getAccountType=()=>o}let o=$.client_app_code,c=$.client_uuidentity;if(o||c){let e={};e.id=$.client_app_id,
e.code=o,e.name=$.client_app_name;let t=$.client_uuappkey||$.client_appkey;t&&(e.uuAppKey=g.parse(t)),e.authenticationLevelOfAssurance=$.client_acr,e.type=$.client_uuidentity_type;let i=$.client_uri
;if(i){if(e.uri=i,e.uri&&e.uri.startsWith(I)){let[t,i]=e.uri.replace(I,"").split(/[:\/](.*)/),[n,s]=i.split(/[:\-]/);e.code||(e.code=t.toUpperCase().replace(/-/g,".")),
...
let[t,i,n]=e.code.toLowerCase().split(/[\.\-_]/),s=`${t}-${i}-${n}`;e.vendor=t,e.app=i,e.subApp=n,e.product=s,e.uri=`${I}${s}`}y=new d(c,e),P=new p(c,e)}let E=$.act;if(E){
let e,t=n.getString(`${R}uu_identity_claim`);e=t?E[t]:E[w]||$[S];let i=E[k],s=E[A]||E[T],r=E.loa,o=E[v],a=E[b]||E[C];a&&(a=g.parse(a));let l=E[x]||U;m=new _(e,{name:i,levelOfAssurance:r,type:s,
...
clientIdentity:y,applicationIdentity:P,attributes:$}),this._configPrefix=R,this._serviceName=e,this._oauthClient=t,this._supportedAcrValues=i,this._idToken=r,this._accessToken=o,
...
let t,i=await y.getClientId(this._serviceName)
...
;return new this.constructor(this._serviceName,this._oauthClient,p,d,h.id_token,h.access_token)}async close(){super.close();let e=await y.getClientCredentials(this._serviceName)
...
static _createEmptySession(){return new m}assertTrustiness(e={}){let t=e.minAuthenticationLevelOfAssurance
;if(null!=t&&null!=t&&t>this.getAuthenticationLevelOfAssurance())throw new f(this,"Minimum login level of assurance not met.");let i=e.maxAuthenticationAge;if(null!=i&&null!=i){
if(this.getAuthenticationTime().getTime()/1e3+i<Date.now()/1e3)throw new f(this,"User re-authentication required.")}}}},333:(e,t,i)=>{
...
;(r=r.split(/\//).slice(0,-1).join("/")+"/").substr(-o.length)!==o&&(o="/4.x/"),r.substr(-o.length)===o&&(r=r.substr(0,r.length-o.length)+"/4.0.1/"),i.p=r,e.exports=i(40);var a=e.exports
;a&&"object"==typeof a&&("version"in a||Object.defineProperty(a,"version",{configurable:!0,value:"4.0.1"}),"name"in a||Object.defineProperty(a,"name",{configurable:!0,
...
l.u=e=>"chunks/uu_appg01_oidc/"+e+"-5fe5ed14591a36744ae2.min.js",l.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),s={},r="uu_appg01_oidc_4_0_1:",l.l=(e,t,i,n)=>{if(s[e])s[e].push(t);else{var o,a
...
},i=this.__webpack_jsonp_uu_appg01_oidc_4_0_1_uu_appg01_oidc=this.__webpack_jsonp_uu_appg01_oidc_4_0_1_uu_appg01_oidc||[];i.forEach(t.bind(null,0)),i.push=t.bind(null,i.push.bind(i))})(),l(333)})()));