...
const StatsCalculate = {
  ...
  GetSchemeNamesFailed: class extends WorkspaceError {
    constructor() {
      super(...arguments);
      this.message = "Failed to obtain scheme names from storage.";
      this.code = `${StatsCalculate.UC_CODE}getSchemeNamesFromStorageFailed`;
    }
  }
};
