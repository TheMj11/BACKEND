  ...
  async calculate(awid, collectionName) {
    ...
    if (agggregateCalcSupported) {
      ...
      const mapReduceCmd = {
        ...
        map: "function () { emit(0, { count: 1, dataSize: Object.bsonsize(this), fileIds: [this.fileId]}); }",
        reduce: "function (_, infos) {" +
                  "var count = 0;" +
                  "var dataSize = 0;" +
                  "var fileIds = [];" +
                  ...
                  "});" +
                  "return { count: count, dataSize: dataSize, fileIds: fileIds};" +  
                "}",
        out: { inline: 1 },
        query: { awid }
      };
