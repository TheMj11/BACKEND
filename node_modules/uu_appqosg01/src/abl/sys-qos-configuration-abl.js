...
const APP_QOS_PROGRESS_ITEMS_MAX_COUNT = "uu_app_qos_progress_items_max_count";
const DEFAULT_PROGRESS_ITEMS_MAX_COUNT = 40;
...
class SysQosConfigurationAbl {
  constructor() {
    ...
    this.progressItemsMaxCount = this.opts.get(APP_QOS_PROGRESS_ITEMS_MAX_COUNT, DEFAULT_PROGRESS_ITEMS_MAX_COUNT);
  ...
  _completeAndCacheQuota(params) {
    ...
    newQuota.progressItemsMaxCount && this.setProgressItemsMaxCount(newQuota.progressItemsMaxCount);
  ...
  _composeDefaultQuota() {
    ...
    let progressItemsMaxCount = this.getProgressItemsMaxCount();
  ...
  getProgressItemsMaxCount() {
    return this.progressItemsMaxCount;
  }

  setProgressItemsMaxCount(progressItemsMaxCount) {
    this.progressItemsMaxCount = progressItemsMaxCount;
  }
