...
class Histogram {
   ...
   * @param {boolean} includeThreshold Flag whether count should be returned
   *   only for values within expected range (false, default) or all values.
   * @returns {number} Number of recorded values.
   */
  count(includeThreshold = false) {
    return includeThreshold ? this._cnt + this._threshold_cnt : this._cnt
  }
