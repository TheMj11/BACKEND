...
module.exports = async function (opts) {
  ...
  if (!Fs.existsSync(buildGradlePath)) {
    ...
    } else if (["5x"].includes(uuAppServerVersion)) {
      uuAppDevKitVersion = UU_APP_DEVKIT_5x_VERSION;
      uuAppVersion = UU_APP_SERVER_DEPENDENCY_VERSION_5X;
    } else {
      uuAppDevKitVersion = UU_APP_DEVKIT_6x_VERSION;
      uuAppVersion = UU_APP_SERVER_DEPENDENCY_VERSION_6X;
    }
    let context = {
      uuAppVersion,
      uuAppDevKitVersion,
