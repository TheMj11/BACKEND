...
const { MetricReader: OpenTelemetryMetricReader } = require("@opentelemetry/sdk-metrics");

const MetricFormatter = require("../utils/metric-formatter.js");

class MetricReader extends OpenTelemetryMetricReader {
  /**
   ...
   * @param {object} [options.aggregationSelector]
   * @param {object} [options.aggregationTemporalitySelector]
   */
