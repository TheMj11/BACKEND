...
const AuditLogLogStoreConfig = require("./components/audit-log-log-store-config.js");
...
class LogStoreClient {
  constructor() {
    ...
    this.uuEe = AuditLogLogStoreConfig.getAppLogStoreUuee();
  }

  async importLogRecords(appLogStoreUri, logRecordList, preserveActor = true) {
    const callUri = UriBuilder.parse(appLogStoreUri).setUseCase(IMPORT_UC).toUri();
    ...
    try {
      ...
      throw new Errors.AppLogStoreImport.ImportFailed({}, { appLogStoreUri }, e);
    }
  }
