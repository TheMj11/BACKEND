...
module.exports = class Test {
  ...
  async process() {
    ...
    if (templateType.startsWith("uu5")) {
      let fileList = this.config.commandLineConfig._ || [];
      return await helpers.forwardTaskToUu5Devkit("test", { ...this.config.commandLineConfig, fileList });
    }
    ...
    let configFile = `${__dirname}/../config/jest.config.js`;
