...
const InitOidcClient = {
  ...
  InvalidCredentialsInitToken: class extends OidcCmdError {
    constructor() {
      super(...arguments);
      this.message = "Provided credentials initialization token is not valid or was already used.";
      this.code = `${InitOidcClient.UC_CODE}invalidCredentialsInitToken`;
    }
  },
...
const VerifyAccessPolicy = {

  UC_CODE: `${OidcCmdError.ERROR_PREFIX}verifyAccessPolicy/`,

  IntegrationNotEnabled: class extends OidcCmdError {
    constructor() {
      super(...arguments);
      this.message = "Integration with uuOidcg02 is not enabled.";
      this.code = `${VerifyAccessPolicy.UC_CODE}integrationNotEnabled`;
      this.status = 500;
    }
  },
  ...
  LoadingOfOidcClientConfigurationFailed: class extends OidcCmdError {
    constructor() {
      super(...arguments);
      this.message = "Loading of OidcClient configuration failed.";
      this.code = `${VerifyAccessPolicy.UC_CODE}loadingOfOidcClientConfigurationFailed`;
      this.status = 500;
    }
  },
  ...
  NoOidcClientConfigured: class extends OidcCmdError {
    constructor() {
      super(...arguments);
      this.message = "No OidcClient is configured for awid, call oidc/initOidcClient first.";
      this.code = `${VerifyAccessPolicy.UC_CODE}noOidcClientConfigured`;
      this.status = 500;
    }
  },
  ...
  RetrievingOfOidcClientFailed: class extends OidcCmdError {
    constructor() {
      super(...arguments);
      this.message = "Retrieving of OidcClient failed.";
      this.code = `${VerifyAccessPolicy.UC_CODE}retrievingOfOidcClientFailed`;
      this.status = 500;
    }
  },
  ...
  OidcClientDoesNotExist: class extends OidcCmdError {
    constructor() {
      super(...arguments);
      this.message = "OidcClient does not exist.";
      this.code = `${VerifyAccessPolicy.UC_CODE}oidcClientDoesNotExist`;
      this.status = 500;
    }
  },

  UntrustedSession: class extends OidcCmdError {
    constructor() {
      super(...arguments);
      this.message = "Session is not trusted as it does not meet expected criteria.";
      this.code = `${VerifyAccessPolicy.UC_CODE}untrustedSession`;
      this.status = 401;
    }
  }
