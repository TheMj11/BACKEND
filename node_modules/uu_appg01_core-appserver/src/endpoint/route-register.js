...
class RouteRegister {
  ...
  set(useCase, useCasePattern, data, method, skipSort = false) {
  ...
  get(useCase, uriProduct, method = null, byName = false, getAllMethods = false) {
    ...
    if (this._registerProductsExpression[uriProduct]) {
      let from = this._registerProductsExpression[uriProduct];
      let result = this._getUseCase(useCaseName, from, method, getAllMethods);
      if (result != null) {
        return result;
      }
